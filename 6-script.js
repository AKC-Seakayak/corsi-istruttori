...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Pulsanti stampa (i PDF si ottengono dalla stampa -> Salva come PDF)
    ...
    // Se vuoi mantenere i pulsanti di esportazione PDF, puoi reindirizzarli alla stampa:
    ...
    async function showStudentEditView(student) {
        ...
        for (let item of didatticheItems) {
            ...
            const safeItem = escapeHtml(item);
            didatRows += `<td><td style="font-weight:bold;">${safeItem}</td>
