...
// Liste abilità tecniche (invariate)
...
// AGGIUNTA DELLE NUOVE VOCI NELLE VALUTAZIONI DIDATTICHE
const didatticheItems = [
    ...
    "Attività",
    "Sommario",
    "IDEAS Lezioni Prova eseguite",   // nuova voce
    "Altri metodi didattici"          // nuova voce
];
...
// ===================== FUNZIONI EXPORT/IMPORT (invariate, ma usano didatticheItems aggiornato) =====================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ===================== EXPORT / IMPORT ASCOLTI =====================
    const exportCourseXlsx = document.getElementById('export-course-xlsx');
    const exportCourseCsv = document.getElementById('export-course-csv');
    if (exportCourseXlsx) exportCourseXlsx.addEventListener('click', () => exportCourse('xlsx'));
    if (exportCourseCsv) exportCourseCsv.addEventListener('click', () => exportCourse('csv'));

    const exportStudentXlsx = document.getElementById('export-student-xlsx');
    const exportStudentCsv = document.getElementById('export-student-csv');
    if (exportStudentXlsx) exportStudentXlsx.addEventListener('click', () => exportStudent('xlsx'));
    if (exportStudentCsv) exportStudentCsv.addEventListener('click', () => exportStudent('csv'));
