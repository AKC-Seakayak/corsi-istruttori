...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function printCourse() {
        ...
        const fullHtml = `
            ...
            <html>
            <head>
                <title>${escapeHtml(course.name)} - Stampa/PDF</title>
                <style>
            ...
            <body>
                <h2>${escapeHtml(course.name)} - Stampa / PDF</h2>
    ...
    printCourseBtn.addEventListener('click', printCourse);
    ...
    async function printStudent() {
        ...
        const fullHtml = `
            ...
            <html>
            <head>
                <title>${escapeHtml(student.name)} ${escapeHtml(student.surname)} - Stampa/PDF Scheda</title>
                <style>
                    body { font-family: 'Inter', Arial, sans-serif; margin: 15px; font-size: 10pt; line-height: 1.3; }
                    h3 { margin: 0 0 8px; font-size: 14pt; }
                    h4 { margin: 12px 0 6px; font-size: 11pt; }
    ...
    if (printStudentBtn) printStudentBtn.addEventListener('click', printStudent);

    // ===================== FUNZIONI ESISTENTI (invariate tranne che per currentEditingStudent) =====================
        ...
        const formHTML = `
            <div class="form-section">
                ...
                <div class="accordion-section" id="accordion-tech">
                    ...
                    <div class="accordion-content"><div style="overflow-x:auto;"><table class="evaluation-table"><tbody>${techRows}</tbody></td></div></div>
                </div>
