...
async function exportCourse(format) {
    ...
    const data = allievi.map(s => ({
        ...
        "Giudizio finale": s.giudizioFinale,
        ...(s.evaluations || {}),
        ...(s.didattiche || {}),
...
document.addEventListener('DOMContentLoaded', () => {
            ...
            studentsHtml += `
                <div style="${pageBreak}">
                    ...
                    <table border="1" cellpadding="4" style="width:100%; margin-bottom:15px;">
                        ...
                        <tr><th>Note</th></table>${escapeHtml(s.psicoAttitudinali?.note || '')}</td></tr>
                    </table>
            ...
            try {
                ...
                for (const row of rows) {
                    const studentData = {
                        ...
                        giudizioFinale: row["Giudizio finale"] || "",
                        evaluations: {},
                        didattiche: {},
                    ...
                    // Mappa valutazioni tecniche (colonne con lo stesso nome delle abilità)
    ...
    // Listener per pulsante stampa singola
    ...
    // ===================== FUNZIONI PRINCIPALI (loadCourses, render, etc.) =====================
